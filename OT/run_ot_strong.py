...
#TODO:
#task='dmc'
#DATASET1, DATASET1_PATH = 'SN', '/home/zyang/viper_rl/ot_data/target.h5'
#DATASET2, DATASET2_PATH = 'TN', '/home/zyang/viper_rl/ot_data/merged.h5'

task='atari'
DATASET1, DATASET1_PATH = 'SN', '/home/zyang/XViper/ot_data/atari/gray_atari.h5' # source
DATASET2, DATASET2_PATH = 'TN', '/home/zyang/XViper/ot_data/atari/color_atari.h5' # target

T_ITERS = 10
f_LR, T_LR = 1e-4, 1e-4
IMG_SIZE = 64 # has to be 32, 64, 128... N times 32
...
OUTPUT_PATH = './checkpoints/{}/{}/{}_{}_{}/'.format(COST, task, DATASET1, DATASET2, IMG_SIZE)
...
# ------------------------- create stats file ----------
DATASET_LIST = [('SN', DATASET1_PATH, 64),('TN', DATASET2_PATH, 64)]
...
for DATASET, DATASET_PATH, IMG_SIZE in tqdm(DATASET_LIST):
    ...
    stats_path = './stats/{}/'.format(task)
    if not os.path.exists(stats_path):
        os.makedirs(stats_path)

    filename = './stats/{}/{}_{}_test.json'.format(task, DATASET, IMG_SIZE)
    with open(filename, 'w') as fp:
        json.dump(stats, fp)
    print('States saved to {}'.format(filename))
# ------------------------- END stats file ----------

filename = './stats/{}/{}_{}_test.json'.format(task, DATASET2, IMG_SIZE)
...
wandb.init(name=EXP_NAME, project='strong_ot', entity='zhao666', config=config)
