...
def main(argv=None):
  ...
  task_list = ['atari_pong', 'atari_assault', 'atari_atlantis', 'atari_boxing', 'atari_freeway', 'atari_kangaroo', 'atari_zaxxon']
  atari_mask_path = '/home/zyang/XViper/viper_rl_data/checkpoints/atari_vqgan/mask_map.pkl'
