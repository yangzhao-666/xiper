...
python scripts/train_dreamer.py --configs=dmc_vision videogpt_prior_rb --task=$TASK --reward_model=dmc_clen16_fskip4 --reward_model_use_ot=False --logdir=./logdir/${TASK}/${AGENT}/${SEED}>"test_${SEED}.out" 2>&1
